                                            ...
                                            <div class="row g-3 mb-4">
                                                <div class="col-sm-4 d-flex align-items-center">
                                                    <div class="form-check mt-3 mt-sm-0">
                                                        <input class="form-check-input" type="checkbox" value="1" id="event-scoring-department-enabled" data-scoring-path="grouping.department.enabled" data-type="boolean">
                                                        <label class="form-check-label" for="event-scoring-department-enabled"><?= htmlspecialchars(t('scoring_designer.sections.grouping.enabled'), ENT_QUOTES, 'UTF-8') ?></label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
