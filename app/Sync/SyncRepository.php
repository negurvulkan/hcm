...
class SyncRepository
{
    ...
    private const SCOPE_DEFINITIONS = [
        ...
        'classes' => [
            'table' => 'classes',
            'id_column' => 'id',
            'columns' => ['id', 'event_id', 'label', 'arena', 'event_arena_id', 'start_time', 'end_time', 'max_starters', 'judge_assignments', 'rules_json', 'tiebreaker_json', 'start_number_rules', 'scoring_rule_snapshot', 'updated_at'],
            'version_column' => 'updated_at',
            'dependencies' => [
    ...
    private function isDeletionRecord(array $record): bool
    {
        ...
        $hasValidChecksum = array_key_exists('checksum', $meta)
            && is_string($meta['checksum'])
            && $meta['checksum'] !== '';
